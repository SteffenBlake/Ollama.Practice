...
summarizer_agent = Agent(
    ...
    information using semantic search in a Qdrant database and summarize it professionally.""",
    tools=[qdrant_tool],
    llm=llm,
    verbose=True
)
...
quiz_maker_agent = Agent(
    ...
    backstory="You are a knowledgeable educator who creates clear, engaging multiple-choice quizzes based on semantic search results.",
    tools=[qdrant_tool],
    llm=llm,
    verbose=True
)
...
quiz_solver_agent = Agent(
    ...
    backstory="You are an intelligent assistant skilled at understanding and answering multiple-choice quizzes accurately.",
    tools=[qdrant_tool],
    llm=llm,
    verbose=True
)
